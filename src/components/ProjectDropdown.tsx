  ...
  const menuItems = [
    {
      icon: (
        <div className="relative mr-2">
          <Sparkle className="h-5 w-5 text-[#6E59A5]" />
          <div className="absolute top-0 -right-0 h-[6px] w-[6px] text-[#6E59A5]">
          ...
          <div className="absolute -bottom-0 -left-0 h-[4px] w-[4px] text-[#6E59A5]">
            <span className="absolute inset-0 rotate-0">
